...
**Example** When rolling a fair die 5 times, what is the probability of no sixes? Of no more than one six?
...
**Example** Say we have $X, Y, Z \sim N(0, 1)$ and set $M=\max \left\{|X|,|Y|, |Z|\right\}$. What is the mean and standard deviation of $M$?
...
**Example (Symmetric Random Walk in R)** Let  $P(Z_i=-1) = P(Z_i=1) = \frac12$ and $X_n = \sum_{i=1}^n Z_i$. Let A>0 some integer. Let's write a routine that finds the median number of steps the walk takes until it hits either -A or A.
...
**Example** The following you find in any basic stats course: A $100(1-\alpha)$% confidence interval for the success probability in a sequence of n Bernoulli trials is given by
